    ...
    >
      ...
      >
        ...
        <div className="relative h-32 sm:h-40 w-full overflow-hidden">
          ...
          <div
            className={`absolute bottom-2 sm:bottom-3 left-3 sm:left-4 text-xs sm:text-sm font-mono ${
        ...
        <div className="p-4 sm:p-6">
          <h3 className="text-base sm:text-xl font-bold text-gray-100 mb-2 sm:mb-3">{event.title}</h3>
          <p className="text-sm sm:text-base text-gray-400 leading-relaxed">{event.description}</p>
        </div>
      </motion.div>
      ...
      <div className="relative flex flex-col items-center flex-shrink-0">
        ...
        {index < timelineEvents.length - 1 && (
          <div className="w-0.5 h-24 sm:h-32 bg-gradient-to-b from-gray-600 to-transparent" />
        )}
      </div>
...
export default function StoryTimeline() {
  ...
  return (
    <div ref={containerRef} className="relative py-8 sm:py-16">
      {/* Animated center line - hidden on mobile */}
      ...
      {/* Timeline events */}
      <div className="relative space-y-6 sm:space-y-8 max-w-4xl mx-auto px-2 sm:px-4">
